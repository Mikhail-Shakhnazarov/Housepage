        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
            ...
            >
                ...
                <div className="glass-card p-8 rounded-3xl space-y-6">
                    ...
                    <button className="w-full border-2 border-primary/20 text-primary font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-primary/5 transition-all">
